...
namespace CSharpFitsTests.Fits
{
    ...
    public class BinaryTableTester
    {
        ...
        {
            CSharpFITS.FITS.Fits f = null;

            try
            {
                FitsFactory.UseAsciiTables = false;

                f = new CSharpFITS.FITS.Fits();
                Object[] data = new Object[]
                {
                    bytes, bits, bools, shorts, ints,
                    floats, doubles, longs, strings
                };
                f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(data));
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt1.fits"));
                f.Read();
        ...
        public void TestRowDelete()
        {
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt1x.fits"));
                f.Read();
        ...
        public void TestVar()
        {
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt2.fits"), FileAccess.Read);
                f.Read();
                BinaryTableHDU bhdu = (BinaryTableHDU) f.GetHDU(1);
        ...
        public void TestSet()
        {
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt2a.fits"));
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt2b.fits"));
                bhdu = (BinaryTableHDU) f.GetHDU(1);
                Assert.AreEqual(true, ArrayFuncs.ArrayEquals(bhdu.GetElement(3, 1), vf[3]));
                Assert.AreEqual(true, ArrayFuncs.ArrayEquals(bhdu.GetElement(4, 1), vf[4]));
                Assert.AreEqual(true, ArrayFuncs.ArrayEquals(bhdu.GetElement(5, 1), vf[5]));
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt2c.fits"));
                bhdu = (BinaryTableHDU) f.GetHDU(1);
                Assert.AreEqual(true, ArrayFuncs.ArrayEquals(bhdu.GetElement(3, 1), vf[3]));
                Assert.AreEqual(false, ArrayFuncs.ArrayEquals(bhdu.GetElement(4, 1), vf[4]));
                Assert.AreEqual(true, ArrayFuncs.ArrayEquals(bhdu.GetElement(4, 1), trw));
        ...
        public void BuildByColumn()
        {
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits();
                f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(btab));
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt3.fits"));
                BinaryTableHDU bhdu = (BinaryTableHDU) f.GetHDU(1);
        ...
        public void TestObj()
        {
            ...
            {
                f = new CSharpFITS.FITS.Fits();
                BasicHDU hdu = CSharpFITS.FITS.Fits.MakeHDU(x);
                f.AddHDU(hdu);
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt6.fits"));
        ...
        public void TestDegenerate()
        {
            ...
            try
            {
                ...
                BinaryTableHDU bhdu = (BinaryTableHDU) CSharpFITS.FITS.Fits.MakeHDU(data);
                Header hdr = bhdu.Header;
                f.AddHDU(bhdu);
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt7.fits"));
                bhdu = (BinaryTableHDU) f.GetHDU(1);
                hdr = bhdu.Header;
                Assert.AreEqual(2, hdr.GetIntValue("TFIELDS"));
                Assert.AreEqual(10, hdr.GetIntValue("NAXIS2"));
        ...
        public void TestDegen2()
        {
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("bt8.fits"));
                BinaryTableHDU bhdu = (BinaryTableHDU) f.GetHDU(1);
