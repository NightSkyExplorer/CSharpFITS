...
namespace CSharpFitsTests.Fits
{
    ...
    public class ImageTest
    {
        ...
        public void MakeFile()
        {
            ...
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(bimg));
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(simg));
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(iimg));
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(limg));
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(fimg));
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(dimg));
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(img3));
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(img1));
        ...
        public void ReadFile()
        {
            ...
            try
            {
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("image1.fits"));
