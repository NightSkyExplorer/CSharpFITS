...
namespace CSharpFitsTests.Fits
{
    ...
    public class RandomGroupsTest
    {
        ...
        public void TestRandomGroup()
        {
            ...
            BasicHDU hdu = CSharpFITS.FITS.Fits.MakeHDU(data);
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("rg1.fits"));
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("rg2.fits"));
