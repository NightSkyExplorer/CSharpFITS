...
namespace CSharpFitsTests.Fits
{
    ...
    public class AsciiTableTest
    {
        ...
        CSharpFITS.FITS.Fits MakeAsciiTable()
        {
            Object[] obj = GetSampleCols();

            // Create new AsciiTable
            CSharpFITS.FITS.Fits f = new CSharpFITS.FITS.Fits();
            f.AddHDU(CSharpFITS.FITS.Fits.MakeHDU(obj));
            return f;
        }

        void WriteFile(CSharpFITS.FITS.Fits f, String name)
        {
        ...
        public void CreateByColumn()
        {
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("at1.fits"), FileAccess.Read);
        ...
        public void CreateByRow()
        {
            ...
            try
            {
                ...
                // Read it back.
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("at2.fits"), FileAccess.Read);
        ...
        public void ModifyTable()
        {
            ...
            try
            {
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("at1.fits"), FileAccess.ReadWrite);
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("at1x.fits"), FileAccess.Read);
        ...
        public void Delete()
        {
            ...
            try
            {
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("at1y.fits"));
                ...
                f = new CSharpFITS.FITS.Fits(TestFileSetup.GetTargetFilename("at1z.fits"));
                th = (TableHDU) f.GetHDU(1);
                Assert.AreEqual(1, th.NCols);
            }
            finally
